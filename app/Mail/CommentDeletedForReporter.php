...
class CommentDeletedForReporter extends KeelearningNotification
{
    ...
    public function __construct(?string $statusExplanation, Comment $comment, User $user)
    {
        ...
        $this->pushNotificationMessage = __('notifications.reported_comment_was_deleted', [], $user->getLanguage());
