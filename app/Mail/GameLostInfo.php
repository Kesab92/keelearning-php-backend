...
class GameLostInfo extends KeelearningNotification
{
    ...
    public function __construct(Game $game, User $opponent, User $user)
    {
        ...
        $this->pushNotificationMessage = __('notifications.game_lost_against', ['name' => $opponent->username], $user->getLanguage());
