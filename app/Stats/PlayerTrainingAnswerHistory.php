...
/**
 * Calculates the amount of questions the user answered correctly during training.
 */
class PlayerTrainingAnswerHistory extends Statistic
{
    /**
     * @var
     */
    ...
    {
        return 'player-training-answer-history-'.$this->playerId;
    }
}
